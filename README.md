# ICAP Website - React TypeScript Project

## 🏗️ **Project Restructuring Overview**

This project has been restructured from a traditional component-based structure to a **feature-first modular architecture** for better scalability and maintainability.
